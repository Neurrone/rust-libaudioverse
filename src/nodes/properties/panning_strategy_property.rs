...
impl PanningStrategyProperty {
    pub fn get(&self) -> Result<PanningStrategy> {
        ...
        match value {
            libaudioverse_sys::Lav_PANNING_STRATEGIES_Lav_PANNING_STRATEGY_HRTF => Ok(PanningStrategy::Hrtf),
            libaudioverse_sys::Lav_PANNING_STRATEGIES_Lav_PANNING_STRATEGY_STEREO => Ok(PanningStrategy::Stereo),
            libaudioverse_sys::Lav_PANNING_STRATEGIES_Lav_PANNING_STRATEGY_SURROUND40 => Ok(PanningStrategy::Surround40),
            libaudioverse_sys::Lav_PANNING_STRATEGIES_Lav_PANNING_STRATEGY_SURROUND51 => Ok(PanningStrategy::Surround51),
            libaudioverse_sys::Lav_PANNING_STRATEGIES_Lav_PANNING_STRATEGY_SURROUND71 => Ok(PanningStrategy::Surround71),
            _ => Err(Error {
