use std::ffi::{CString};
use super::super::{libaudioverse_sys, buffer, server};
use super::Node;
use super::properties::{ distance_model_property, float_property, float3_property, float6_property, int_property, panning_strategy_property };
use check;
use Result;
...
impl EnvironmentNode {
    ...
    pub fn new(server : &server::Server, hrtf_path : &CString) -> Result<EnvironmentNode> {
        ...
        check(unsafe { libaudioverse_sys::Lav_createEnvironmentNode(server.handle, hrtf_path.as_ptr(), &mut node_handle) })?;
        Ok(EnvironmentNode { handle : node_handle })
    }
    ...
    pub fn default_reverb_distance(&self) -> float_property::FloatProperty {
        float_property::FloatProperty { index : libaudioverse_sys::lav_STANDARD_ENVIRONMENT_PROPERTIES_Lav_ENVIRONMENT_REVERB_DISTANCE,  node_handle : self.handle }
    }
    ...
    pub fn default_size(&self) -> float_property::FloatProperty {
        float_property::FloatProperty { index : libaudioverse_sys::lav_STANDARD_ENVIRONMENT_PROPERTIES_Lav_ENVIRONMENT_DEFAULT_SIZE,  node_handle : self.handle }
    }
    ...
    pub fn distance_model(&self) -> distance_model_property::DistanceModelProperty {
        distance_model_property::DistanceModelProperty { index : libaudioverse_sys::lav_STANDARD_ENVIRONMENT_PROPERTIES_Lav_ENVIRONMENT_DISTANCE_MODEL,  node_handle : self.handle }
    }
    ...
    pub fn max_distance(&self) -> float_property::FloatProperty {
        float_property::FloatProperty { index : libaudioverse_sys::lav_STANDARD_ENVIRONMENT_PROPERTIES_Lav_ENVIRONMENT_MAX_DISTANCE,  node_handle : self.handle }
    }
    ...
    pub fn max_reverb_level(&self) -> float_property::FloatProperty {
        float_property::FloatProperty { index : libaudioverse_sys::lav_STANDARD_ENVIRONMENT_PROPERTIES_Lav_ENVIRONMENT_MAX_REVERB_LEVEL,  node_handle : self.handle }
    }
    ...
    pub fn min_reverb_level(&self) -> float_property::FloatProperty {
        float_property::FloatProperty { index : libaudioverse_sys::lav_STANDARD_ENVIRONMENT_PROPERTIES_Lav_ENVIRONMENT_MIN_REVERB_LEVEL,  node_handle : self.handle }
    }
    ...
    pub fn orientation(&self) -> float6_property::Float6Property {
        float6_property::Float6Property { index : libaudioverse_sys::lav_STANDARD_ENVIRONMENT_PROPERTIES_Lav_ENVIRONMENT_ORIENTATION,  node_handle : self.handle }
    }
    ...
    pub fn output_channels(&self) -> int_property::IntProperty {
        int_property::IntProperty { index : libaudioverse_sys::lav_STANDARD_ENVIRONMENT_PROPERTIES_Lav_ENVIRONMENT_OUTPUT_CHANNELS,  node_handle : self.handle }
    }
    ...
    pub fn panning_strategy(&self) -> panning_strategy_property::PanningStrategyProperty {
        panning_strategy_property::PanningStrategyProperty { index : libaudioverse_sys::lav_STANDARD_ENVIRONMENT_PROPERTIES_Lav_ENVIRONMENT_PANNING_STRATEGY,  node_handle : self.handle }
    }
    ...
    pub fn position(&self) -> float3_property::Float3Property {
        float3_property::Float3Property { index : libaudioverse_sys::lav_STANDARD_ENVIRONMENT_PROPERTIES_Lav_ENVIRONMENT_POSITION,  node_handle : self.handle }
    }
    ...
    pub fn play_async(&self, buffer : &buffer::Buffer, x : f32, y : f32, z : f32, is_dry : bool) -> Result<()> {
        check(unsafe { libaudioverse_sys::Lav_environmentNodePlayAsync(self.handle, buffer.handle, x, y, z, is_dry as i32) })?;
        Ok(())
    }
}